...
public class MyOrderAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final MyOrderBean mingxiBean = arrayList.get(i);
        //先截取需要的网络图片第一张
...
//        v.tv_fangan.setText(mingxiBean.getData().getPageInfo().getList().get(i).get);
        ...
        if (TextUtils.isEmpty(mingxiBean.getData().getPageInfo().getList().get(i).getBuy_num())){
            ...
            v.tv_fenshu.setText(mingxiBean.getData().getPageInfo().getList().get(i).getBuy_num());
        }
...
//                Log.e("值1",mingxiBean.getData().getPageInfo().getList().get(i).getID()+"");
        ...
        v.tv_orderpay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent  = new Intent(context,PayjifenActivity.class);
