...
public class AddressAdapter2 extends BaseAdapter{
    ...
    CallBack cb;
    public AddressAdapter2(Context context, ArrayList<AddressBean> arrayList, CallBack cb){
...
//                context.startActivity(intent);
                sharedPreferencesHelper.put("addressid",addressBean.getData().get(i).getId()+"");
                sharedPreferencesHelper.put("addressname",addressBean.getData().get(i).getAdd_name());
                sharedPreferencesHelper.put("addressphone",addressBean.getData().get(i).getAdd_mobile()+"");
                sharedPreferencesHelper.put("addressdizhi",addressBean.getData().get(i).getArea_diqu()+addressBean.getData().get(i).getAdd_dizhi());
