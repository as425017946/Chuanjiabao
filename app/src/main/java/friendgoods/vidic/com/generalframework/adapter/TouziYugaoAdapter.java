...
public class TouziYugaoAdapter extends BaseAdapter {
    Context context;
    ArrayList<TouziYugaoBean> arrayList;
    public TouziYugaoAdapter(Context context,ArrayList<TouziYugaoBean> arrayList){
...
//        if (yugaoBean.getData().getPageInfo().getList().get(i).getItems_photo1()==null){
//
//        }else {
//
//        }
        ...
        //转换类型状态
        if (yugaoBean.getData().getPageInfo().getList().get(i).getFunding_type()==null){
