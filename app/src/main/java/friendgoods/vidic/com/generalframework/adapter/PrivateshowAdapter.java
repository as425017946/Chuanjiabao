...
public class PrivateshowAdapter extends BaseAdapter {
    Context context;
    ArrayList<PrivateRenBean> arrayList;
    public PrivateshowAdapter(Context context, ArrayList<PrivateRenBean> arrayList){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        final PrivateRenBean privateRenBean = arrayList.get(i);
        viewHolder.tv_time.setText(privateRenBean.getData().get(i).getCreation_time());
        viewHolder.tv_xinxi.setText(privateRenBean.getData().get(i).getPrivate_file_name());
        //显示公开资料，点击下载
            ...
            public void onClick(View view) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra("url",privateRenBean.getData().get(i).getPrivate_file_url());
