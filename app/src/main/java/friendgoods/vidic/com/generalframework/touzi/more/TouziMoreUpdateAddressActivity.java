 ...
 * 修改地址
 */
public class TouziMoreUpdateAddressActivity extends BaseActivity {
...
//        ToastUtils.longToast(ids+name+phone+falgs+diqu+dizhi);
                                    ...
                                    .execute(new StringCallback() {
                                        ...
                                        public void onSuccess(String s, Call call, Response response) {
                                            ...
                                            if(wechatBindBean.getState()==1){
                                                ToastUtils.longToast("地址修改成功！");
                                                Handler handler = new Handler();
                                                handler.postDelayed(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        TouziMoreUpdateAddressActivity.this.finish();
                                                    }
                                                },1000);
                                            }else {
    ...
    private void setinfo(){
        l_xuanze.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                OptionsPickerView pvOptions = new OptionsPickerBuilder(TouziMoreUpdateAddressActivity.this, new OnOptionsSelectListener() {
                    @Override
